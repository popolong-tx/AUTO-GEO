...
DEFAULT_TOPICS = [
    {
        ...
        "name": "新能源汽车闪充技术发布会",
        "description": "新能源汽车闪充技术发布会舆情分析",
        "icon": "⚡",
        "default_prompt": """请针对新能源汽车闪充技术发布会开展全面深入的舆情分析，以海外社交媒体反馈为核心，结合国内外平台进行对比洞察。从技术传播、用户体验、竞品对比、基础设施影响等维度展开多层次逻辑推理和因果链分析，尤其关注以下要点：

闪充技术亮点在海外的传播热度、接受程度，以及官方演示与用户实际反馈的差异。
与特斯拉、宁德时代等竞品充电技术的海外讨论量、情绪倾向和用户偏好对比。
安全、电网负荷、实际场景适配性等质疑在海外的演化路径、峰值变化及传播特征。
发布会前后14天内海外市场热度持续性及对品牌形象、销量的实际影响。
...
请基于真实、可交叉验证的数据进行客观、中立、可靠的分析，所有结论均需有数据支撑，避免推测性表述。""",
    ...
    },
    {
        ...
        "name": "汽车行业第一季度财报",
        "description": "汽车行业第一季度财报舆情与市场影响分析",
        "icon": "📊",
        "default_prompt": """请针对汽车行业企业第一季度财报开展专业、深入的舆情与市场影响分析，以海外市场反馈为核心，结合国内外多源数据进行对比洞察。从财务指标解读、投资者情绪、竞品对比、资本市场反应等维度展开多层次逻辑推理和因果链分析，尤其关注以下重点：
...
请基于真实、可验证的数据进行客观、严谨、可靠的分析，所有结论均需有明确数据或来源支撑。""",
    ...
    },
    {
        ...
        "name": "智能驾驶芯片发布会",
        "description": "智能驾驶芯片发布会深度分析",
        "icon": "🧠",
        "default_prompt": """请针对智能驾驶芯片发布会开展深度舆情与技术竞争力分析，以海外社交媒体反馈为核心，结合国内外平台进行对比洞察。从技术参数解读、用户信任构建、竞品对比、品牌形象影响等维度展开多层次逻辑推理和因果链分析，尤其关注以下重点：
...
品牌形象提升：发布会对企业高端化与智能驾驶形象的实际拉动作用。

数据要求：

重点整合发布会前后14天内的全平台实时数据。
...
请基于最新可获取的真实数据，进行客观、严谨且具有前瞻性的分析，注重深层逻辑关联与全球用户视角，提供高实用价值的技术传播与品牌提升建议。""",
    ...
    },
    {
        "id": "dod-1260h-list",
        "name": "国防部1260h清单事件",
        "description": "汽车行业企业被列入国防部1260h清单舆情风险分析",
        "icon": "🛡️",
        "default_prompt": """请针对汽车行业企业被列入国防部1260h清单的事件开展全面舆情风险与危机传播分析，以海外舆情为核心，结合国内外多语言数据进行深度对比洞察。从事件演变、舆情差异、连锁影响、企业回应等维度展开多层次逻辑推理和因果链分析，尤其关注以下重点：

事件全貌梳理：事件具体细节、官方解读以及完整时间线还原。
国内外舆情差异：国内（爱国情绪、国产替代预期）与国际（供应链担忧、出口限制、地缘风险）舆情的显著差异、互动传播及情绪特征。
连锁市场反应：对企业海外业务、股价、合作伙伴以及新能源产业链的潜在影响与传导路径。
企业回应效果：企业及相关方回应策略的传播效果、公众接受度及信任修复情况。
...
请基于最新可获取的真实数据，进行客观、严谨且具有前瞻性的分析，注重深层逻辑关联、中美关系背景与全球舆情动态，提供高可操作性的危机管理建议。""",
    ...
    },
    {
        ...
        "name": "Goodwood Festival of Speed活动",
        "description": "2026年汽车行业参加Goodwood活动海外舆情分析",
        "icon": "🏁",
        "default_prompt": """请针对汽车行业企业参加2026年Goodwood Festival of Speed（https://www.goodwood.com/motorsport/festival-of-speed/）开展全面深入的舆情分析，以海外社交媒体反馈为核心，结合国内外平台进行对比洞察。从活动传播、用户体验、竞品对比、品牌形象、性能文化认知等维度展开多层次逻辑推理和因果链分析，尤其关注以下要点：

活动传播热度：企业在Goodwood活动中的曝光、传播热度、海外受众接受程度，以及现场展示与海外用户真实反馈之间的差异。
竞品对比讨论：与特斯拉、保时捷、Rimac、莲花等性能/电动竞品在Goodwood语境下的讨论量、情绪倾向和用户偏好对比。
品牌与性能叙事：企业在海外高性能、豪华、赛道/爬坡等场景中的品牌认知变化，以及是否形成"技术实力"或"性能突破"的新叙事。
